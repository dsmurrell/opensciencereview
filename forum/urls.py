...
core_urls = (
    ...
    url(r'^%s$' % _('papers/'), app.readers.questions, name='questions'),
    url(r'^%s%s$' % (_('papers/'), _('ask/')), app.writers.ask, name='ask'),
    url(r'^%s%s$' % (_('papers/'), _('related_papers/')), app.commands.related_questions, name='related_questions'),

    url(r'^%s%s$' % (_('papers/'), _('unanswered/')), app.readers.unanswered, name='unanswered'),
    url(r'^%s(?P<mode>[\w\-]+)/(?P<user>\d+)/(?P<slug>.*)/$' % _('papers/'), app.readers.user_questions, name='user_questions'),
    
    
    url(r'^%s(?P<id>\d+)/%s$' % (_('papers/'), _('edit/')), app.writers.edit_question, name='edit_question'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('papers/'), _('close/')), app.commands.close, kwargs=dict(close=True), name='close'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('papers/'), _('reopen/')), app.commands.close, kwargs=dict(close=False), name='reopen'),
    url(r'^%s(?P<id>\d+)/%s$' % (_('papers/'), _('response/')), app.writers.answer, name='answer'),
    ...
    url(r'^%s%s(?P<user_id>\d+)/%s(?P<answer_id>\d+)/$' % (_('award_points/'), _('user/'), _('response/')), app.commands.award_points, name='award_points'),
    ...
    url(r'^%s(?P<id>\d+)/(?P<slug>[\w-]*)$' % _('question/'), 'django.views.generic.simple.redirect_to', {'url': '/papers/%(id)s/%(slug)s'}),
    url(r'^%s(?P<id>\d+)/?$' % _('papers/'), app.readers.question, name='question'),
    url(r'^%s(?P<id>\d+)/(?P<slug>.*)/(?P<answer>\d+)$' % _('papers/'), app.readers.question),
    url(r'^%s(?P<id>\d+)/(?P<slug>.*)$' % _('papers/'), app.readers.question, name='question'),

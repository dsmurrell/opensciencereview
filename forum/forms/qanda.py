...
class TitleField(forms.CharField):
    def __init__(self, *args, **kwargs):
        ...
        self.label  = _('title')
        self.help_text = _('please enter the exact title of the paper above, followed by the abstract below. Include a link below the abstract.')
        self.initial = ''
...
class TagNamesField(forms.CharField):
    def __init__(self, user=None, *args, **kwargs):
        ...
        self.help_text = _('Tags are short keywords. Separate with spaces. Use between %(min)s and %(max)s tags. Form complex tags using underscores, eg: climate_change') % {
...
class WikiField(forms.BooleanField):
    def __init__(self, disabled=False, *args, **kwargs):
        ...
        self.help_text = _('if you choose community wiki option, the post and reviews will not generate points and name of author will not be shown')
        if disabled:
